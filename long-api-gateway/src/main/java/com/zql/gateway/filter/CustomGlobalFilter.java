package com.zql.gateway.filter;

import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.URLUtil;
import com.yupi.apiclientsdk.utils.SignUtils;
import com.zql.gateway.exception.BusinessException;
import com.zql.longapicommon.common.ErrorCode;
import com.zql.longapicommon.model.entity.InterfaceInfo;
import com.zql.longapicommon.model.entity.User;
import com.zql.longapicommon.model.entity.UserInterfaceInfo;
import com.zql.longapicommon.service.InnerInterfaceInfoService;
import com.zql.longapicommon.service.InnerUserInterfaceInfoService;
...
public class CustomGlobalFilter implements GlobalFilter, Ordered {
    ...
    public static final List<String> IP_WHITE_LIST = Collections.unmodifiableList(Arrays.asList("127.0.0.1", "8.130.179.81", "172.31.23.83"));
...
//        }
        ...
        String serverSign = SignUtils.genSign(invokeUser.getSecretKey());
                            ...
                            return super.writeWith(
                                    fluxBody.map(dataBuffer -> {
                                        ...
                                        try {
                                            ...
                                            addInterfaceNum(exchange.getRequest(), interfaceInfoId, userId);
                                        } catch (Exception e) {
...
//    public Mono<Void> handleResponse(ServerWebExchange exchange, GatewayFilterChain chain, Long interfaceInfoId, Long interfaceInfoUserId) {
//        try {
//            ServerHttpResponse originalResponse = exchange.getResponse();
//            //缓存数据的工厂
//            DataBufferFactory bufferFactory = originalResponse.bufferFactory();
...
//                            return super.writeWith(
//                                    fluxBody.map(dataBuffer -> {
//                                        //7.调用成功后，次数+ 1,其实就是修改数据库
//                                        try {
//                                            innerUserInterfaceInfoService.invokeCount(interfaceInfoId, interfaceInfoUserId);
//                                        } catch (Exception e) {
